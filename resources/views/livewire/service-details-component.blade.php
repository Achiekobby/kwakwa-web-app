                                ...
                                <div class="row">
                                        ...
                                        <div class="post-header">
                                            ...
                                            <div class="post-info-wrap">
                                                <h2 class="post-title"><a href="#" title="Post Format: Standard"
                                                        rel="bookmark">{{ $service->service_name }}: {{ $service->service_category->category_title }}</a></h2>
                                    ...
                                    <div class="col-md-12">
                                        <div id="single-carousel">
                                            <div class="img-hover">
                                                <img src="{{ asset('images/services') }}/{{ $service->service_image }}" alt="{{ $service->service_name }}"
                            ...
                            <aside>
                                ...
                                <div class="col-md-12 col-sm-6 col-xs-12 bg-dark color-white padding-top-mini"
                                    ...
                                    <a href="{{ route('home.service_details',['service_slug'=>$related_service->slug]) }}">
                                        <div class="img-hover">
                                            <img src="{{ asset('images/services/thumbnails') }}/{{ $related_service->service_image }}" alt="{{ $related_service->service_name }}"
                                                class="img-responsive">
                                        </div>
                                        <div class="info-gallery">
                                            ...
                                            <hr class="separator">
                                            <p> {{ $related_service->service_name }}</p>
